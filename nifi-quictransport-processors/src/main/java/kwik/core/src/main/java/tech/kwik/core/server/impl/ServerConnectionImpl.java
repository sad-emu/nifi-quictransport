 ...
 */
package kwik.core.src.main.java.tech.kwik.core.server.impl;
...
import kwik.core.src.main.java.tech.kwik.core.ConnectionEstablishedEvent;
import kwik.core.src.main.java.tech.kwik.core.QuicStream;
import kwik.core.src.main.java.tech.kwik.core.ack.GlobalAckGenerator;
import kwik.core.src.main.java.tech.kwik.core.cid.ConnectionIdManager;
import kwik.core.src.main.java.tech.kwik.core.common.EncryptionLevel;
import kwik.core.src.main.java.tech.kwik.core.common.PnSpace;
import kwik.core.src.main.java.tech.kwik.core.crypto.CryptoStream;
import kwik.core.src.main.java.tech.kwik.core.frame.CryptoFrame;
import kwik.core.src.main.java.tech.kwik.core.frame.HandshakeDoneFrame;
import kwik.core.src.main.java.tech.kwik.core.frame.NewTokenFrame;
import kwik.core.src.main.java.tech.kwik.core.frame.QuicFrame;
import kwik.core.src.main.java.tech.kwik.core.frame.RetireConnectionIdFrame;
import kwik.core.src.main.java.tech.kwik.core.impl.*;
import kwik.core.src.main.java.tech.kwik.core.log.LogProxy;
import kwik.core.src.main.java.tech.kwik.core.log.Logger;
import kwik.core.src.main.java.tech.kwik.core.packet.*;
import kwik.core.src.main.java.tech.kwik.core.send.SenderImpl;
import kwik.core.src.main.java.tech.kwik.core.server.ApplicationProtocolConnectionFactory;
import kwik.core.src.main.java.tech.kwik.core.server.ApplicationProtocolSettings;
import kwik.core.src.main.java.tech.kwik.core.server.ServerConnection;
import kwik.core.src.main.java.tech.kwik.core.server.ServerConnectionConfig;
import kwik.core.src.main.java.tech.kwik.core.server.ServerConnectionRegistry;
import kwik.core.src.main.java.tech.kwik.core.stream.FlowControl;
import kwik.core.src.main.java.tech.kwik.core.stream.StreamManager;
import kwik.core.src.main.java.tech.kwik.core.tls.QuicTransportParametersExtension;
import kwik.core.src.main.java.tech.kwik.core.util.Bytes;
import kwik.core.src.main.java.tech.kwik.core.util.InetTools;
...
import static kwik.core.src.main.java.tech.kwik.core.QuicConstants.TransportErrorCode.INVALID_TOKEN;
import static kwik.core.src.main.java.tech.kwik.core.QuicConstants.TransportErrorCode.PROTOCOL_VIOLATION;
import static kwik.core.src.main.java.tech.kwik.core.QuicConstants.TransportErrorCode.TRANSPORT_PARAMETER_ERROR;
import static kwik.core.src.main.java.tech.kwik.core.common.EncryptionLevel.Initial;
import static kwik.core.src.main.java.tech.kwik.core.impl.QuicConnectionImpl.Status.Connected;
import static kwik.core.src.main.java.tech.kwik.core.impl.QuicConnectionImpl.Status.Handshaking;
import static kwik.core.src.main.java.tech.kwik.core.impl.QuicConnectionImpl.VersionNegotiationStatus.VersionChangeUnconfirmed;
...
public class ServerConnectionImpl extends QuicConnectionImpl implements ServerConnection, TlsStatusEventHandler {
    ...
    public ServerConnectionImpl(Version originalVersion, DatagramSocket serverSocket, InetSocketAddress initialClientAddress,
                                ...
                                int forcedMTUSize) {
        super(originalVersion, Role.Server, null, new LogProxy(log, originalDcid), configuration, forcedMTUSize);
